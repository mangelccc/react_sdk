...
/**
 * Componente SidebarChats - Panel lateral con lista de chats
 * @param {Object} props - Props del componente
 * @param {boolean} props.estaAbierto - Estado de apertura del sidebar
 * @param {Function} props.alCerrar - Función para cerrar sidebar
 * @param {Array} props.chats - Lista de chats disponibles
 * @param {Object} props.chatActual - Chat actualmente seleccionado
 * @param {Function} props.alSeleccionarChat - Función al seleccionar un chat
 * @param {Function} props.alCrearNuevoChat - Función para crear nuevo chat
 * @param {boolean} props.cargando - Estado de carga
 * @returns {JSX.Element} - Panel lateral renderizado
 */
const SidebarChats = ({ 
  estaAbierto, 
  alCerrar, 
  ...
  return (
    <>
      ...
      <aside
        className={`sidebarChats ${estaAbierto ? 'sidebarChats--abierto' : ''}`}
      >
